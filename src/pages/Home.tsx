...
// Flying Chess section moved below header + stacked buttons
...
export default function Home() {
  ...
  const downloads = [
    ...
    { platform: 'Downl 3 Patti Teen', link: 'https://flyingchess.com/?from_gameid=8173353&channelCode=100000' },
    { platform: 'Download 3 Patti Gold', link: 'https://flyingchess.com/?from_gameid=8477993&channelCode=100000' },
    { platform: 'Doanlod 3 Patti No 1', link: 'https://3pattiteen.com/?from_gameid=8418021&channelCode=8307610' },
    { platform: 'Download 3 Patti Lucky', link: 'https://flyingchess.com/?from_gameid=8173353&channelCode=100000' },
    { platform: 'Download 3 Patti Room', link: 'https://flyingchess.com/?from_gameid=8477993&channelCode=100000' }
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10 py-20">
          ...
          >
           ...
           {/* Download Buttons Directly Under Hero */}
        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-4">
          {downloads.map((item, index) => (
            <motion.a
              ...
              className="group w-full text-center px-6 py-3 bg-black text-white border-2 border-gray-800 rounded-lg hover:border-blue-500 hover:shadow-lg transition-all max-w-sm"
            >
              <Download className="inline-block w-5 h-5 mr-2 text-white-700 group-hover:text-blue-600 transition-colors" />
              <span className="text-white-900 font-medium group-hover:text-blue-600">{item.platform}</span>
            </motion.a>
          ))}
        </div>
      </section>
